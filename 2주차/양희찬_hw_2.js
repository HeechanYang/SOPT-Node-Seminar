...
const server = http.createServer((req, res) => {
    ...
    if (urlParsed.pathname === PATH_SIGN_IN) {
        signIn(parsedQuerystring, res);
    } else if (urlParsed.pathname === PATH_SIGN_UP) {
        signUp(parsedQuerystring, res);
...
// 회원가입
function signUp(parsedQuerystring, res){
    let resMsg = {
        msg: ""
    };
...
// 로그인
function signIn(parsedQuerystring, res){
    let resMsg = {
        msg: ""
    };
